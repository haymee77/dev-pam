...
var ForgotPassword2Component = /** @class */ (function () {
     ...
     */
    ForgotPassword2Component.prototype.onForgotPasswordFormValuesChanged = function () {
...
var LockComponent = /** @class */ (function () {
     ...
     * On form values changed
     */
    LockComponent.prototype.onLockFormValuesChanged = function () {
...
var Login2Component = /** @class */ (function () {
     ...
     * On destroy
     */
    Login2Component.prototype.ngOnDestroy = function () {
        // Unsubscribe from all subscriptions
        this._unsubscribeAll.next();
        this._unsubscribeAll.complete();
    };
     ...
     * On form values changed
     */
    Login2Component.prototype.onLoginFormValuesChanged = function () {
...
var LoginComponent = /** @class */ (function () {
    ...
    function LoginComponent(_fuseConfigService, _formBuilder, _httpClient) {
        ...
        this.redirect_uri = encodeURI('/api/auth/kakao');
        // Configure the layout
        this._fuseConfigService.config = {
            layout: {
                navbar: {
...
var Register2Component = /** @class */ (function () {
     ...
     * On form values changed
     */
    Register2Component.prototype.onRegisterFormValuesChanged = function () {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        ...
        this.registerForm.valueChanges
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this._unsubscribeAll))
            .subscribe(function () {
            _this.onRegisterFormValuesChanged();
        });
    };
...
var ResetPassword2Component = /** @class */ (function () {
     ...
     * On form values changed
     */
    ResetPassword2Component.prototype.onResetPasswordFormValuesChanged = function () {
...
var ResetPasswordComponent = /** @class */ (function () {
     ...
     * On form values changed
     */
    ResetPasswordComponent.prototype.onResetPasswordFormValuesChanged = function () {
        for (var field in this.resetPasswordFormErrors) {
            if (!this.resetPasswordFormErrors.hasOwnProperty(field)) {
                continue;
            }
...
/* harmony import */ var app_main_pages_search_search_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/main/pages/search/search.service */ "./src/app/main/pages/search/search.service.ts");
/* harmony import */ var app_main_pages_search_search_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/main/pages/search/search.component */ "./src/app/main/pages/search/search.component.ts");
/* harmony import */ var app_main_pages_search_tabs_classic_classic_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/main/pages/search/tabs/classic/classic.component */ "./src/app/main/pages/search/tabs/classic/classic.component.ts");
/* harmony import */ var app_main_pages_search_tabs_table_table_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/main/pages/search/tabs/table/table.component */ "./src/app/main/pages/search/tabs/table/table.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'search',
        component: app_main_pages_search_search_component__WEBPACK_IMPORTED_MODULE_6__["SearchComponent"],
        resolve: {
            search: app_main_pages_search_search_service__WEBPACK_IMPORTED_MODULE_5__["SearchService"]
        }
    }
];
var SearchModule = /** @class */ (function () {
    ...
    SearchModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                app_main_pages_search_search_component__WEBPACK_IMPORTED_MODULE_6__["SearchComponent"],
                app_main_pages_search_tabs_classic_classic_component__WEBPACK_IMPORTED_MODULE_7__["SearchClassicComponent"],
                app_main_pages_search_tabs_table_table_component__WEBPACK_IMPORTED_MODULE_8__["SearchTableComponent"]
            ],
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes),
            ...
            providers: [
                app_main_pages_search_search_service__WEBPACK_IMPORTED_MODULE_5__["SearchService"]
            ]
        })
    ], SearchModule);
    return SearchModule;
